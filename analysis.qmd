...
As mentioned earlier, the FIPS code column names are different in the two datasets, so I need to specify the column names when merging the datasets using `inner_join()`.
:::
